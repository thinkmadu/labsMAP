...
public class Main {
    public static void main(String[] args) throws TurmaException, AlunoException, ProfessorException{
        ...
        sig.getAdministracao().agendarReuniaoDaDiretoria(LocalDateTime.of(2022, 3, 8, 11, 0, 0));
        sig.getAdministracao().agendarReuniaoDaDiretoria(LocalDateTime.of(2022, 3, 10, 11, 0, 0));
        System.out.println(sig.getAdministracao().reunioesAgendadasDiretoria());

        //agendar entrevista
        System.out.println("Agenda de entrevitas da diretoria");
        sig.getAdministracao().agendarEntrevista(LocalDateTime.of(2022, 3, 9, 12, 0, 0));
        sig.getAdministracao().agendarEntrevista(LocalDateTime.of(2022, 3, 12, 18, 30, 0));
        System.out.println(sig.getAdministracao().entrevistasAgendadas());
